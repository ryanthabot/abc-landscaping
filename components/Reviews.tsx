    ...
    <section id="reviews" className="relative py-24">
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          ...
          {/* Read Reviews CTA Card */}
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ delay: 0.5, type: 'spring', stiffness: 80 }}
            className="bg-background rounded-3xl p-8 shadow-sm border-2 border-dashed border-primary/20 hover:shadow-lg hover:border-primary/40 transition-all duration-300 flex flex-col items-center justify-center text-center"
          >
            ...
            <a
              ...
              className="inline-flex items-center gap-2 bg-primary text-primary-foreground font-heading font-semibold px-6 py-3 rounded-2xl hover:bg-primary/90 transition-colors shadow-md"
            >
